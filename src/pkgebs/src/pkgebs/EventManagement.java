...
//    }
    ...
    //Function to search through a list of events to find one that has a matching event name.
    ...
    //Return single event from file based on event name
