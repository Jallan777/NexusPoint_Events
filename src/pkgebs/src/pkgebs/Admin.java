...
public class Admin {
    ...
    // Can also add and delete users, and see how many bookings have been made over all.
    ...
    public void setTotalUsers() {
        ...
        this.totalUsers = tUsers;           //Changed code from File IO to JavaDB
    }
    ...
    //Admin Login validator, checks the username and password are the same as the one on file
    //I decided to leave the admin details on a text file
    ...
    //Dynamic greeting for admin when they log in
