...
public class FileHandling {
    ...
    //File Handling class has been mostly dropped, and most code now relies
    //on the embedded database to store information. However the admin still works off paper, 
    //and some functions are called randomly across the program, mostly to do with the admin info
